...
criterion = WeberFechnerLoss(base_criterion=base_criterion, weber_weight=0.3)
...
model = train_model(model, train_dataloader, val_dataloader, criterion, optimizer, num_epochs, 'vit_WF_loss_v1.txt')

# Evaluate the model
print("Evaluating model...")
test_acc = evaluate_model(model, test_dataloader, 'vit_WF_loss_v1.txt')
