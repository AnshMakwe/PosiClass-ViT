...
model = train_model(model, train_dataloader, val_dataloader, criterion, optimizer, num_epochs, 'vit_bag_of_attention_v3.txt')

# Evaluate the model
print("Evaluating model...")
test_acc = evaluate_model(model, test_dataloader, 'vit_bag_of_attention_v3.txt')
